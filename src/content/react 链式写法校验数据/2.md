...
https://codesandbox.io/s/unruffled-poincare-lx7uq
...
export default class Joi {
    ...
    // 日期是否之间
    isBetween(
        dates = [moment().format('YYYY-MM-DD'), moment().add('day', 1).format('YYYY-MM-DD')],
        message = `${this.name || '日期'}请选择${dates[0]}至${dates[1]}` 
    ) {
